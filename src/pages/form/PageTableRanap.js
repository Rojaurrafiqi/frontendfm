...
const PageTableRanap = () => {
  ...
  function fetchData() {
    axios
      .get(`${API_URL}/form/default/ranap/`)
      .then((response) => {
  ...
  const handleDeleteData = async (id) => {
    try {
      await axios.delete(`${API_URL}/form/default/ranap/${id}`);
    } catch (error) {
      console.error(error);
