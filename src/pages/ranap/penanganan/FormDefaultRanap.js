...
const FormDefaultRanap = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const result = await axios.get(`${API_URL}/form/default/ranap`);
      setData(result.data);
    };
    fetchData();
  }, []);
    ...
    <div>
      <div className="container pb-5">
        <div class="flex">
          ...
          <div className="container bg-white m-4 w-4/5">
            {result == null ? (
...
export default FormDefaultRanap;
